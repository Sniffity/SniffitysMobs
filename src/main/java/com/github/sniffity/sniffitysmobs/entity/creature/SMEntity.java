...
public abstract class SMEntity extends PathfinderMob implements IAnimatable {
    ...
    private static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SMEntity.class, EntityDataSerializers.STRING);
    /**
     * ANIMATION_TYPE:
     * Case 1: LOOP
     * Case 2: PLAY_ONCE
     ...
     */
    private static final EntityDataAccessor<Integer> ANIMATION_TYPE = SynchedEntityData.defineId(SMEntity.class, EntityDataSerializers.INT);
