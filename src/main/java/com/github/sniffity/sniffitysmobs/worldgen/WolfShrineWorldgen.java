package com.github.sniffity.sniffitysmobs.worldgen;
...
public class WolfShrineWorldgen {
    private static final ResourceLocation wolfShrineStructurePlains = new ResourceLocation("sniffitysmobs", "village/wolf_shrine_plains");
    private static final ResourceLocation wolfShrineStructureTaiga = new ResourceLocation("sniffitysmobs", "village/wolf_shrine_taiga");
    private static final ResourceLocation wolfShrineStructureSavanna = new ResourceLocation("sniffitysmobs", "village/wolf_shrine_savanna");
    private static final ResourceLocation wolfShrineStructureDesert = new ResourceLocation("sniffitysmobs", "village/wolf_shrine_desert");
    private static final ResourceLocation wolfShrineStructureSnowy = new ResourceLocation("sniffitysmobs", "village/wolf_shrine_snowy");
