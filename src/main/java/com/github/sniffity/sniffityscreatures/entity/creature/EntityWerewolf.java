...
public class EntityWerewolf extends SCEntity {
    ...
    public EntityWerewolf(EntityType<? extends SCEntity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public EntityWerewolf(EntityType<? extends SCEntity> type, Level worldIn, int bloodthirstStacks, int textureVariant) {
        super(type, worldIn);
    ...
    public SpawnGroupData finalizeSpawn(@NotNull ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType reason, @javax.annotation.Nullable SpawnGroupData data, @javax.annotation.Nullable CompoundTag dataTag)
    {
        ...
        if (getBloodthirstStacks() > 0) {
            this.addEffect(new MobEffectInstance(SCEvents.BLOODTHIRST.get(),2147483647, getBloodthirstStacks(),false,false));
        }
